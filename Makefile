# Docker image name
APP_IMAGE := shahadathhs/ecommerce-inventory-api:latest
...
logs:
	docker compose -f $(COMPOSE_FILE) logs -f ecommerce_inventory_api

# Cleanup everything
clean: down
	docker volume rm ecommerce_inventory_api || true
